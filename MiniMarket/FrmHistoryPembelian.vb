Public Class FrmHistoryPembelian
    ...
    Private Sub FrmHistoryPembelian_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Call Data_Record()
        KeluarBtn.Enabled = True
    End Sub

    Sub Data_Record()
        tblHistory = Proses.ExecuteQuery("Select * from Vw_HistoryPembelian")
    ...
    Private Sub CariData_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CariData.TextChanged
        ...
        If RbFaktur.Checked = True Then
            tblHistory = Proses.ExecuteQuery("Select * From Vw_HistoryPembelian where Faktur_Pembelian Like '%" & CariData.Text & "%'")
        ...
        ElseIf RbKdBarang.Checked = True Then
            tblHistory = Proses.ExecuteQuery("Select * From Vw_HistoryPembelian where Kode_Barang Like '%" & CariData.Text & "%'")
            If tblHistory.Rows.Count = 0 Then
                DGHistory.DataSource = tblHistory
                CariData.Focus()
            Else
