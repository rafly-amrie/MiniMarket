...
Public Class ClsKoneksi
    ...
    Public Function OpenConn() As Boolean
        Cn = New OleDb.OleDbConnection("Provider=SQLOLEDB.1;Integrated Security=SSPI;Persist Security Info=False;User ID=;Password=;Initial Catalog=DBMiniMarket;Data Source=DESKTOP-UE01ITQ\SQLEXPRESS")
        Cn.Open()
